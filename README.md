...
Работа всех методов в апи step зависит от наличия в реестре необходимого набора конфигов в правильном формате. В случае использования тестового API Raida набор конфигов должен быть следующим:
```
"task_status_id": {
