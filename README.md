...
Работа всех методов сервиса step зависит от наличия в реестре необходимого набора конфигов, которые используются для взаимодействия с API Raida. В случае использования тестового API Raida набор конфигов должен быть следующим:
```
"task_status_id": {
